...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `flux` with the `NAME` of your provider.
...
- binary: pulumi-resource-flux
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-flux/provider/pkg/version.Version={{.Tag}}
...
├── config.yaml
├── metadata.json
├── pulumi-flux_darwin_amd64_v1
│   └── pulumi-resource-flux
├── pulumi-flux_darwin_arm64
│   └── pulumi-resource-flux
├── pulumi-flux_linux_amd64_v1
│   └── pulumi-resource-flux
├── pulumi-flux_linux_arm64
│   └── pulumi-resource-flux
├── pulumi-flux_windows_amd64_v1
│   └── pulumi-resource-flux.exe
└── pulumi-flux_windows_arm64
    └── pulumi-resource-flux.exe
```
